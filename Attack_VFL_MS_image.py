...
if __name__ == '__main__':
    ...
    train_data_1, test_data_1, shadow_data_1, num_classes1_1, num_classes2_1, channel_1, hideen_1 = load_data(args.dataset1, args.attack_label,
    ...
    if model == 'resnet':
        ...
        client_model_fake_1 = ResNet18(level=level2, hideen1=hideen_2, num_classes=num_cutlayer).to(device)
