...
if __name__ == '__main__':
    ...
    # Define records path
    writer_1, writer_2 = records_path(save_path, acti1, dataset,  num_cutlayer)

    writer_shadow_1, writer_shadow_2 = records_shadow_path(save_path, acti1, dataset,  num_cutlayer)
    ...
    save_path1 = f'Results/{dataset}/{acti1}/num_client2/n{noise_scale}/client1_c{num_cutlayer}_{acti1}_epoch{epochs-1}_b{len(train_iter)-1}.pth'
    save_path2 = f'Results/{dataset}/{acti1}/num_client2/n{noise_scale}/client2_c{num_cutlayer}_{acti1}_epoch{epochs-1}_b{len(train_iter)-1}.pth'
    save_path3 = f'Results/{dataset}/{acti1}/num_client2/n{noise_scale}/server_c{num_cutlayer}_{acti1}_{batch_size}_epoch{epochs-1}_b{len(train_iter)-1}.pth'
